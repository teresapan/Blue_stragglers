...
int symbol;
{
  ...
  p = (core *) b_allocate((unsigned) (sizeof(core) + (n - 1) * sizeof(short)));
...
/*  register unsigned *rend; JF unused */
  ...
  p = (core *) b_allocate((unsigned) (sizeof(core) - sizeof(short)));
...
save_shifts()
{
  ...
  p = (shifts *) b_allocate((unsigned) (sizeof(shifts) +
...
save_reductions()
{
  ...
  if (count)
    {
      p = (reductions *) b_allocate((unsigned) (sizeof(reductions) +
...
/*  register int found; JF unused */
      ...
      if (sp->number == 0)
	{
	  ...
	  if (statep->accessing_symbol == start_symbol)
	      ...
	      while (sp->number < k)
		{
	      ...
	      if (sp->number == k)
		{
		  sp2 = (shifts *) b_allocate((unsigned) (sizeof(shifts)
  ...
  statep = (core *) b_allocate((unsigned) (sizeof(core) - sizeof(short)));
